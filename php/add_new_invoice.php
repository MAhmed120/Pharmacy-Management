<?php
// Handle actions based on the 'action' parameter in the GET request
...
// Function to check if a medicine exists
...
// Function to create a new row for medicine information
function createMedicineInfoRow() {
  ...
  <div class="row col col-md-12">
    ...
    <div class="col col-md-2">
      ...
      <button class="btn btn-danger" onclick="removeRow('<?php echo $row_id ?>');"><i class="fa fa-trash"></i></button>
    </div>
  </div>
  <div class="col col-md-12"><hr class="col-md-12" style="padding: 0px;"></div>
  <?php
}

// Function to retrieve the next invoice number
...
// Function to show the medicine list for datalist suggestions
function showMedicineList($text) {
  require 'db_connection.php';
  if ($con) {
    $query = ($text == "") ? "SELECT * FROM medicines_stock" : "SELECT * FROM medicines_stock WHERE UPPER(NAME) LIKE '%$text%'";
    $result = mysqli_query($con, $query);
...
// Function to fill fields with medicine information
...
// Function to check available quantity of a medicine
...
// Helper function to get a customer ID by name and contact number
