...
function createHeader($icon, $heading, $sub_heading) {
    ...
    <section class="row content-header">
      <div class="header-title col-md-11">
        ...
        <small class="font-weight-bold h6">'.$sub_heading.'</small>
      </div>
      <div class="col-md-1 user_options">
        ...
        <ul id="options" class="options list-unstyled" style="display: none;">
          <li><a href="my_profile.php"><i class="fa fa-user"></i><span>My Profile</span></a></li>
          <li><a href="change_password.php"><i class="fa fa-edit"></i><span>Change Password</span></a></li>
