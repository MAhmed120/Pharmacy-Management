...
function addNewPurchase() {
    ...
    $voucher_number = isset($_GET['voucher_number']) ? $_GET['voucher_number'] : null;
    $invoice_number = $_GET['invoice_number'];
    ...
    if($con) {
        $query = "INSERT INTO purchases (VOUCHER_NUMBER, SUPPLIER_NAME, INVOICE_NUMBER, PURCHASE_DATE, TOTAL_AMOUNT, PAYMENT_STATUS) VALUES('$voucher_number', '$suppliers_name', $invoice_number, '$invoice_date', $grand_total, '$payment_status')";
        $result = mysqli_query($con, $query);
        echo ($result) ? "Purchase saved..." : "Failed to save purchase!";
    }
}
